...
- `Test_C2FViT.py`: Register an image pair with a pretrained C2FViT model.
- 
## Inference

`python Test_C2FViT.py --model {model_path} --fixed {fixed_img_path} --moving {moving_img_path}
`
For brain template-matching (MNI152), the `fixed_img_path` should set to `../Data/MNI152_T1_1mm_brain_pad_RSP.nii.gz`.
...
MICCAI 2021. [eprint arXiv:2203.15216](https://arxiv.org/abs/2203.15216)
